...
frenteFan22preta.addEventListener("click", function(){
    frenteFan22Preta.setAttribute("src", "../static/img/frente/frente fan 22/frente fan 22 preta.png");
});

frenteFan22Verm.addEventListener("click", function(){
    frenteFan22Preta.setAttribute("src", "../static/img/frente/frente fan 22/frente fan 22 Verm.png");
});
...
frenteTitan22preta.addEventListener("click", function(){
    frenteFan22Preta.setAttribute("src", "../static/img/frente/frente titan 22/frente titan 22 preta.png");
});

frenteTitan22Verm.addEventListener("click", function(){
    frenteFan22Preta.setAttribute("src", "../static/img/frente/frente titan 22/frente titan 22 Verm.png");
});
...
frenteTwpreta.addEventListener("click", function(){
    frenteFan22Preta.setAttribute("src", "../static/img/frente/frente tw/frente tw preta.png");
});

frenteTwVerm.addEventListener("click", function(){
    frenteFan22Preta.setAttribute("src", "../static/img/frente/frente tw/frente tw Verm.png");
});
...
peDPreto.addEventListener("click", function(){
    raiadaD.setAttribute("src", "../static/img/roda/pe/dianteira/preto/preto.png");
});

peTPreto.addEventListener("click", function(){
    raiadaT.setAttribute("src", "../static/img/roda/pe/traseira/preto.png");
});

raiadaDir.addEventListener("click", function(){
    raiadaD.setAttribute("src", "../static/img/roda/raiada/dianteira.png");
});

raiadaTras.addEventListener("click", function(){
    raiadaT.setAttribute("src", "../static/img/roda/raiada/traseira.png");
});
...
paralamaPeVerm.addEventListener("click", function(){
    raiadaD.setAttribute("src", "../static/img/roda/pe/dianteira/preto/vermelho.png");
});
...
paralamaRaiVerm.addEventListener("click", function(){
    raiadaD.setAttribute("src", "../static/img/roda/raiada/paralama/vermelha.png");
});
...
carenagemTrasVerm.addEventListener("click", function(){
    carenagemTrasPreta.setAttribute("src", "../static/img/carenagem/traseira/carenagemTrasVerm.png");
});

carenagemTraspreta.addEventListener("click", function(){
    carenagemTrasPreta.setAttribute("src", "../static/img/carenagem/traseira/carenagemTrasPreta.png");
});
...
rabetaorig01.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaOrig01.png");
});

rabetaOrig02.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaOrig02.png");
});

rabetaOrig03.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaOrig03.png");
});

rabetaOrig04.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaOrig04.png");
});

rabetaOrig05.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaOrig05.png");
});

rabetaOrig06.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaOrig06.png");
});

rabetaNvI01.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvI01.png");
});

rabetaNvI02.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvI02.png");
});

rabetaNvI03.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvI03.png");
});

rabetaNvII01.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvII01.png");
});

rabetaNvII02.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvII02.png");
});

rabetaNvII03.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvII03.png");
});

rabetaNvII04.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvII04.png");
});

rabetaNvII05.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvII05.png");
});

rabetaNvIII01.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvIII01.png");
});

rabetaNvIII02.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvIII02.png");
});

rabetaNvIII03.addEventListener("click", function(){
    rabetaOrig01.setAttribute("src", "../static/img/rabeta/rabetaNvIII03.png");
})
...
alcaOrigCromo.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/alcaOrigCromo.png");
});

alcaOrigpreta.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/alcaOrigPreta.png");
});

alcaAltaCromo.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/alcaAltaCromo.png");
});

alcaAltaPreta.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/alcaAltaPreta.png");
});
...
churrasqueiraCromo.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraCromo.png");
});

churrasqueiraCromoGivi.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraCromoGivi.png");
});

churrasqueiraCromoGiviBau.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraCromoGiviBau.png");
});

churrasqueiraCromoSup.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraCromoSup.png");
});

churrasqueiraCromoSupBau.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraCromoSupBau.png");
});

churrasqueiraPreta.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraPreta.png");
});

churrasqueiraPretaGivi.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraPretaGivi.png");
});

churrasqueiraPretaGiviBau.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraPretaGiviBau.png");
});

churrasqueiraPretaSup.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraPretaSup.png");
});

churrasqueiraPretaSupBau.addEventListener("click", function(){
    alcaOrigPreta.setAttribute("src", "../static/img/alca/churrasqueiraPretaSupBau.png");
});
...
tanqueStartpreto.addEventListener("click", function(){
    tanqueStartPreto.setAttribute("src", "../static/img/tanque/tanqueStartPreto.png");
});

tanqueStartVerm.addEventListener("click", function(){
    tanqueStartPreto.setAttribute("src", "../static/img/tanque/tanqueStartVerm.png");
});
...
escapeOrigprata.addEventListener("click", function(){
    escapeOrigPrata.setAttribute("src", "../static/img/escapamento/original/escapOrigPrata.png");
});

escapeDeLata.addEventListener("click", function(){
    escapeOrigPrata.setAttribute("src", "../static/img/escapamento/delata/escapDeLata.png");
});

escapeDeLataProt.addEventListener("click", function(){
    escapeOrigPrata.setAttribute("src", "../static/img/escapamento/delata/escapDeLataProt.png");
});

escapeTorbal.addEventListener("click", function(){
    escapeOrigPrata.setAttribute("src", "../static/img/escapamento/delata/escapTorbalEstra.png");
});

escapeDoreAzulAT.addEventListener("click", function(){
    escapeOrigPrata.setAttribute("src", "../static/img/escapamento/dore/escapDoreAzulAT.png");
});

escapeDoreVermAT.addEventListener("click", function(){
    escapeOrigPrata.setAttribute("src", "../static/img/escapamento/dore/escapDoreVermAT.png");
});

escapeDorePretoAT.addEventListener("click", function(){
    escapeOrigPrata.setAttribute("src", "../static/img/escapamento/dore/escapDorePretoAT.png");
});

escapeDorePolidoAT.addEventListener("click", function(){
    escapeOrigPrata.setAttribute("src", "../static/img/escapamento/dore/escapDorePolidoAT.png");
});
...
tampaprata.addEventListener("click", function(){
    tampaPrata.setAttribute("src", "../static/img/vazio.png");
});

tampaPreta.addEventListener("click", function(){
    tampaPrata.setAttribute("src", "../static/img/motor/tampaLateral/TampaPretaMotor.png");
});
